...
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-lg shadow p-8 text-center mb-6">
        ...
        <div class="space-y-2">
            ...
            <p class="text-gray-600 text-sm">You will receive an email confirmation shortly. Our team will process your order and contact you with delivery details.</p>
        </div>
    </div>
    ...
    async function loadOrderDetails(id) {
        try {
            ...
            if (response.ok) {
                ...
                const infoHtml = `
                    <div>
                        <p class="mb-3"><span class="font-semibold">Order ID:</span> #${order.id}</p>
                        <p class="mb-3"><span class="font-semibold">Order Date:</span> ${new Date(order.created_at).toLocaleString()}</p>
                        ${itemsHtml}
